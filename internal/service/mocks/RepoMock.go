...
func (mr *MockIRepoMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockIRepo)(nil).Close))
}
...
func (m *MockIRepo) StartMigration(ctx context.Context, dir, dest string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StartMigration", ctx, dir, dest)
	ret0, _ := ret[0].(error)
	return ret0
}

// StartMigration indicates an expected call of StartMigration.
func (mr *MockIRepoMockRecorder) StartMigration(ctx, dir, dest interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StartMigration", reflect.TypeOf((*MockIRepo)(nil).StartMigration), ctx, dir, dest)
}
